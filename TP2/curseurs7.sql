...
cursor affiche(fil filiere.nomfil%type) is select electeurs.idelec, electeurs.nom, electeurs.pnom, electeurs.ddn, electeurs.nvot, electeurs.nvoix, electeurs.cand, filiere.nomfil from electeurs join filiere on electeurs.idfil=filiere.idfil where filiere.nomfil=fil and electeurs.cand=1;
