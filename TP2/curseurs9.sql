...
cursor affiche(vot electeurs.nvot%type) is select electeurs.idelec, electeurs.nom, electeurs.pnom, electeurs.ddn, electeurs.nvot, electeurs.nvoix, electeurs.cand, filiere.nomfil from electeurs join filiere on electeurs.idfil=filiere.idfil where electeurs.cand=1 and nvot>vot;
