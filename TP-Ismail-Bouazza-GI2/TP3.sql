...
INSERT INTO pp VALUES('Bouazza','Ismail',T_b('Centre A',1,'Batiment 1',5),cours_l(T_COURS('BASE DE DONNEE','BD','C',2),T_COURS('PLSQL','BD','TP',4)));
INSERT INTO pp VALUES('Bencherifa','Amal',T_b('Centre A',1,'Batiment 1',9),cours_l(T_COURS('BASE DE DONNEE','BD','TD',4)));
...
INSERT INTO pp VALUES('Fitian','Chaimae',T_b('Centre B',2,'Batiment 2',17),cours_l(T_COURS('WEB AVANCEE','PWA','C',3)));
INSERT INTO pp VALUES('Farih','Mohamed',T_b('Centre B',2,'Batiment 2',15),cours_l(T_COURS('WEB AVANCEE','PWA','TD',3)));
